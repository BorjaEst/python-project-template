...
└── tox.ini                  # Tox configuration to automate and standardize testing
```
...
Just click on [Use this template](https://github.com/BorjaEst/python-project-template/generate) and you are good to go.
